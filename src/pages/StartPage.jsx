  ...
  return (
    <div className="start-container">
      ...
      <p className="asep-disclaimer">
        ...
        αποκλειστικά για εκπαιδευτική χρήση. Δεν συνδέεται ούτε υποστηρίζεται από τον ΑΣΕΠ.<br /><br /><br />
        Copyright © 2025 Φώτης Χ. Κουτσουμπίδης<br />
        Εκπαιδευτική εφαρμογή • Άδεια χρήσης: CC BY-NC-ND 4.0
      </p>
    </div>
  );
}
