...
ℹ️ Η εφαρμογή είναι **ανεπίσημη** και **εκπαιδευτική**, δεν συνδέεται με τον ΑΣΕΠ.
...
├── public/
│   ├── favicon.ico          # Εικονίδιο για browser tab
│   └── fotis.png            # Εικόνα branding/υπογραφής
├── src/
...
- 🌐 SEO-friendly δομή (Open Graph, favicon, meta tags)
...
> Οι ερωτήσεις που περιλαμβάνονται σε αυτή την εφαρμογή προέρχονται από το Μητρώο Θεμάτων του ΑΣΕΠ, όπως δημοσιεύθηκαν στο πλαίσιο της προκήρυξης 1Γ/2025. Η παρούσα εφαρμογή είναι **ανεπίσημη** και προορίζεται αποκλειστικά για **εκπαιδευτική χρήση**. Δεν συνδέεται ούτε υποστηρίζεται από τον ΑΣΕΠ.
